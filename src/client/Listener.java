 ...
 * Purpose: listener the event happened in the clientboard
 * */
...
public class Listener implements ActionListener, MouseMotionListener, MouseListener {
	...
	public void sendDraw() {
		try {
			...
			ClientLogin.connection.outputStream.writeUTF(draw);
			ClientLogin.connection.outputStream.flush();
		} catch (Exception e) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (drawCommand.equals("Line")) {
			...
			frame.setCursor(cursor);
			state = (String) drawCommand;
			JOptionPane.showMessageDialog(frame, "Please click three positions in a row", "Triangle draw tutorial",
